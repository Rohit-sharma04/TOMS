        ...
        <div className="bg-gray-100">
            <div className="bg-white p-6  md:mx-auto">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-600 my-2">We encountered an issue while processing your payment.</p>
                    <p>Please try again or contact support if the issue persists.</p>
                    <div className="py-10 text-center">
                        <Link to="/user/dashboard" className="px-12 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3 rounded">
                            GO BACK
                        </Link>
                    </div>
                </div>
