...
export const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchChallanData = async () => {
      try {
        const toatalChallanStatusData = await axios.get('api/user/user-challan-status-data')
        setChallanPaymentStatus([toatalChallanStatusData.data.data.pendingCount, toatalChallanStatusData.data.data.completedCount]);

        const complaintStatusResponse = await axios.get('api/user/complaint-status-data');
